...
beautiful.init("/usr/share/awesome/themes/xolcman/theme.lua")
...
tags = {}
tags = {
    names  = {"term", "vim", "web","chat","5","6","7","8","9"},
...
mymem = awful.widget.progressbar()
-- Свойства индикатора
mymem:set_width(20)
mymem:set_vertical(true)
mymem:set_background_color("#494B4F")
mymem:set_border_color(nil)
mymem:set_color("#AECF96")
mymem:set_gradient_colors({ "#AECF96", "#88A175", "#FF5656" })
-- Регистрация виджета
...
clientkeys = awful.util.table.join(
    ...
    awful.key({ }, "ISO_Next_Group",  function () kbdcfg.switch() end),
